...
class isaid_strong(data.Dataset):
...
class isaid_strong_cutmix(data.Dataset):
    def __init__(self, root, list_path, downsample_rate=1, num_samples=None, label_flag='remain', base_size=1024,
                 max_iters=None, crop_size=(512, 512), mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225],
                 scale=True, mirror=True, ignore_label=-1, scale_factor=16):
        self.root = root
        self.list_path = list_path
        self.crop_size = crop_size
        self.scale = scale
