...
def get_arguments():
    ...
    parser.add_argument('--cfg',
                        default= '/home/hnu/LY/semi_ly_1008/experiments/vaihingen/SEMI_contast_cutmix.yaml',#'/home/hnu/LY/semi_ly_1008/experiments/postdam/SEMI_contast_cutmix_HC.yaml',
    ...
    for i_epoch in range(1, epoch+1):
        ...
        if i_epoch <= start_unsuper:
            ...
            for bar_supervised, bar_unsupervised, bar_unsupervised_mix in zip(trainloader_gt, trainloader_unlabel, trainloader_unlabel):
                ...
                loss_unsup_mix = loss_unsup_mix #(loss_unsup_mix + loss_mix_contrast) / 2.0
